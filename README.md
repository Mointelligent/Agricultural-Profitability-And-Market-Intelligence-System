...
Determine regions with the highest transport losses.

Calculate the average logistics cost per kilogram sold.

Estimate revenue lost due to spoilage or inefficient transport.
...
sql/ – SQL queries used for aggregation, filtering, and analysis.
...
Standardized crop names, regions, and farmer group identifiers

Verified cost, revenue, and quantity values

Prepared a clean dataset for SQL analysis and visualization

2. Data Analysis (SQL)

Tool: SQL

Calculated total revenue, total cost, and profit per crop

Computed logistics cost per kilogram sold

Identified regions with the highest transport losses

Compared profitability across regions and farmer groups
...
Transport losses across regions
...
Best-performing regions: West and East

Transport losses and logistics costs significantly reduce overall profitability.

Farmer_23 consistently outperformed others and can serve as a benchmark for best practices.
...
Reduce transport losses by improving logistics coordination.

Track logistics cost per kilogram to identify quick efficiency wins.

Long-Term Recommendations

Invest in storage, transportation, and supply chain infrastructure.

Train farmer groups on efficiency, cost control, and profitability best practices.
